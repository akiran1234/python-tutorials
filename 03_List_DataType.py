...
# Index starts with 0 and end with length of list-1.
# Accessing of the list in reverse direction using stride operation -1, -2 and so on..
#################################################################################################################
...
l5=[10,20,30,40.44]      # Applying repeater operation on the numeric list also will be repeated.
